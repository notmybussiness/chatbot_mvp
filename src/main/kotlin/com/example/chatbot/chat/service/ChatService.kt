...
import com.example.chatbot.chat.dto.ThreadResponse
...
class ChatService(
    ...
    fun createChat(userId: UUID, request: ChatCreateRequest): ChatResponse {
        ...
        val messages = contextChats.flatMap {
            listOf(
                com.example.chatbot.common.client.ChatMessage("user", it.question),
                com.example.chatbot.common.client.ChatMessage("assistant", it.answer)
            )
        } + com.example.chatbot.common.client.ChatMessage("user", request.question)
